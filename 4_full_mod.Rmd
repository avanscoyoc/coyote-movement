...
###Full models 
```{r}
full_mod <- glmer(Used ~ tri + veg + road_dist + dev_dist + crop_dist + (1|ID), 
...
plot_model(full_mod,axis.labels=c("Ruggedness","Vegetation Type", "Distance to Road",
...
```{r}
#Plot
jtools::plot_summs(full_mod, scale = TRUE, 
           model.names = "Full",
           coefs = c("tri" = "Ruggedness",
                     "veg" = "Vegetation Type",
                     "road_dist" = "Distance to Road",
                     "dev_dist" = "Distance to Development",
                     "crop_dist" = "Distance to Agriculture"),
           colors = c("black")) 
