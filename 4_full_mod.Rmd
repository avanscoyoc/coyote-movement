...
full_cor[,9:17] %>% 
  set_names("Ruggedness", "Development", "Road", 
            ...
            "Mountain Lion Risk", "Grassland", 
            "Shrubland", "Woodland") %>% 
  cor() %>% 
  knitr::kable() %>% 
  kable_styling("striped", full_width = FALSE, htmltable_class = 'lightable-classic-2') %>% 
  kable_paper() %>% 
  save_kable(file = 'covariate_correlations.png') 

knitr::kable(cor(full_cor[,7:17]))
...
```{r}
likelihoods <- c(93648.15, 96632.17, 93648.15, 94169.25, 96632.17, 93648.15, 96632.17, 94169.25, 93648.15, 93648.15, 96632.17, 93648.15, 93648.15, 93648.15, 96632.17, 96632.17, 93648.15, 93648.15, 94169.25, 93648.15, 93648.15, 93648.15, 93648.15, 93648.15, 93650.15)
