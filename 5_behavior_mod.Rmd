...
rest_mod <- glmer(Used ~ crop_dist.s + grass_dist.s + forest_dist.s + shrub_dist.s + 
                        + slope.s + road_dist.s + dev_dist.s +(1|ID), 
                  data = coyote_rest, family=binomial(link="logit")) #drop elev (correlated w/ crop)

forage_mod <- glmer(Used ~ crop_dist.s + grass_dist.s + forest_dist.s + shrub_dist.s + 
                        + slope.s + road_dist.s + dev_dist.s +(1|ID), 
                  data = coyote_forage, family=binomial(link="logit")) #drop elev (correlated w/ crop)

travel_mod <- glmer(Used ~ crop_dist.s + grass_dist.s + forest_dist.s + shrub_dist.s + 
                        + slope.s + road_dist.s + dev_dist.s +(1|ID), 
...
```{r}
#Best model
jtools::plot_summs(full_mod_alt, rest_mod, forage_mod, travel_mod, scale = TRUE, 
