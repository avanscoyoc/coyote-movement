...
rest_mod <- glmer(Used ~ tri + veg + road_dist + dev_dist + crop_dist + hunter_risk + lion_risk + (1|ID), 
                  data = coyote_rest, family=binomial(link="logit")) #drop elev (correlated w/ crop)

forage_mod <- glmer(Used ~ tri + veg + road_dist + dev_dist + crop_dist + hunter_risk + lion_risk + (1|ID), 
                  data = coyote_forage, family=binomial(link="logit")) #drop elev (correlated w/ crop)

travel_mod <- glmer(Used ~ tri + veg + road_dist + dev_dist + crop_dist + hunter_risk + lion_risk + (1|ID), 
